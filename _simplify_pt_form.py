...
<style>
  ...
  @keyframes pt-step-in { from { opacity:0; transform:translateY(5px); } to { opacity:1; transform:translateY(0); } }
  ...
  .pt-diarias-output {
    ...
    box-shadow:0 8px 24px rgba(37,99,154,.1);
  ...
  .pt-diarias-total-value { color:#143a63; font-size:2rem; line-height:1.04; font-weight:900; letter-spacing:-.01em; }
      ...
      <div class="oficio-wizard-header-card">
        <div class="oficio-wizard-header-main">
          <div class="oficio-wizard-header-copy">
            ...
            <p class="oficio-wizard-header-support">Preencha cada etapa em ordem. Use Voltar e Avançar para navegar.</p>
          </div>
          ...
          <nav class="oficio-stepper" aria-label="Etapas" style="--oficio-step-count:6;">
            <button type="button" class="oficio-stepper-link is-active" data-step-target="0" aria-current="step">
              ...
              <span class="oficio-stepper-copy">
                <span class="oficio-stepper-state">Passo 1 de 6</span>
            ...
            <button type="button" class="oficio-stepper-link" data-step-target="1">
              ...
              <span class="oficio-stepper-copy">
                <span class="oficio-stepper-state">Passo 2 de 6</span>
            ...
            <button type="button" class="oficio-stepper-link" data-step-target="2">
              ...
              <span class="oficio-stepper-copy">
                <span class="oficio-stepper-state">Passo 3 de 6</span>
            ...
            <button type="button" class="oficio-stepper-link" data-step-target="3">
              ...
              <span class="oficio-stepper-copy">
                <span class="oficio-stepper-state">Passo 4 de 6</span>
            ...
            <button type="button" class="oficio-stepper-link" data-step-target="4">
              ...
              <span class="oficio-stepper-copy">
                <span class="oficio-stepper-state">Passo 5 de 6</span>
            ...
            <button type="button" class="oficio-stepper-link" data-step-target="5">
              ...
              <span class="oficio-stepper-copy">
                <span class="oficio-stepper-state">Passo 6 de 6</span>
    ...
    <div class="card oficio-stage-panel" style="margin-top:1rem;">
      <div class="card-body">
        ...
        <div class="pt-summary-bar" id="pt-summary-bar" aria-label="Resumo do plano">
          ...
          <div class="pt-summary-item">
            <span class="pt-summary-label">Pessoas</span>
        ...
        <form method="post" novalidate id="pt-form">
          ...
          <div class="pt-step is-active" data-step-index="0">
            <div class="oficio-stage-intro">
              <span class="oficio-stage-kicker">Passo 1 de 6</span>
              <h2 class="oficio-stage-title">Contexto</h2>
              <p class="oficio-stage-description">Vincule o documento e defina o solicitante.</p>
            </div>
          ...
          {# ════ PASSO 2 — DATAS E ROTEIRO ════ #}
          <div class="pt-step" data-step-index="1">
            <div class="oficio-stage-intro">
              <span class="oficio-stage-kicker">Passo 2 de 6</span>
              <h2 class="oficio-stage-title">Datas e Roteiro</h2>
              <p class="oficio-stage-description">Informe as datas e os destinos do deslocamento.</p>
            </div>
          ...
          <div class="pt-step" data-step-index="2">
            <div class="oficio-stage-intro">
              <span class="oficio-stage-kicker">Passo 3 de 6</span>
              <h2 class="oficio-stage-title">Equipe</h2>
              <p class="oficio-stage-description">Informe o efetivo e selecione os coordenadores.</p>
            </div>
            ...
            <section class="oficio-stage-section">
              ...
              <div class="row g-3 mt-1">
                <div class="col-md-4">
                  ...
                  <div class="form-text">Calculado a partir das linhas acima.</div>
                </div>
              </div>
            </section>
          ...
          <div class="pt-step" data-step-index="3">
            <div class="oficio-stage-intro">
              <span class="oficio-stage-kicker">Passo 4 de 6</span>
          ...
          <div class="pt-step" data-step-index="4">
            <div class="oficio-stage-intro">
              <span class="oficio-stage-kicker">Passo 5 de 6</span>
              <h2 class="oficio-stage-title">Diárias</h2>
              <p class="oficio-stage-description">Informe as quantidades e valores. Se o período estiver preenchido, uma sugestão aparecerá abaixo.</p>
            </div>
              ...
              <div class="pt-diarias-shell">
                <div class="row g-3">
                  <div class="col-6">
                    ...
                    <input type="text" id="pt-diarias-data-inicio" class="form-control form-control-sm text-muted" readonly tabindex="-1">
                  </div>
                  <div class="col-6">
                    <label class="form-label">Retorno</label>
                    <input type="text" id="pt-diarias-data-fim" class="form-control form-control-sm text-muted" readonly tabindex="-1">
                  </div>
                  <div class="col-12">
                    <label class="form-label" for="{{ form.diarias_quantidade.id_for_label }}">Qtd. de diárias</label>
                    {{ form.diarias_quantidade }}
                    <div id="pt-diarias-suggestion" class="pt-diarias-suggestion mt-1" role="status" aria-live="polite">
                      <span id="pt-diarias-suggestion-text"></span>
                      <button type="button" id="btn-aplicar-sugestao" class="btn btn-sm btn-outline-primary ms-auto">Aplicar</button>
                    </div>
                  </div>
                  <div class="col-6">
                    <label class="form-label" for="{{ form.diarias_valor_unitario.id_for_label }}">Valor / diária</label>
                  ...
                  <div class="col-12">
                    <label class="form-label" for="{{ form.diarias_valor_extenso.id_for_label }}">Valor por extenso</label>
          ...
          <div class="pt-step" data-step-index="5">
            <div class="oficio-stage-intro">
              <span class="oficio-stage-kicker">Passo 6 de 6</span>
              <h2 class="oficio-stage-title">Revisão</h2>
              <p class="oficio-stage-description">Verifique os dados antes de salvar.</p>
            </div>
...
(function () {
  ...
  function showStepError(message) {
    let el = document.getElementById('pt-step-error');
    if (!el) {
    ...
    el.style.display = '';
    clearTimeout(el._t);
    el._t = setTimeout(() => { if (el) el.style.display = 'none'; }, 6000);
  }

  // ══════════════════════════════════════════════════════════
  //  STEP NAVIGATION — BLOCKING VALIDATION
  // ══════════════════════════════════════════════════════════
  // Return false to BLOCK advance. Null = no check.
  const stepValidations = [
    null,   // 0 → 1: no block
    () => { // 1 → 2: must have saída date
      if (!dataInicio || !dataInicio.value) {
        showStepError('Informe a data de saída antes de avançar.');
        return false;
      }
    },
    () => { // 2 → 3: must have at least one person
      if (planoState.equipe.total < 1) {
        showStepError('Adicione ao menos um membro no efetivo antes de avançar.');
        return false;
      }
    },
    null,
  ...
  function showStep(index) {
    ...
    if (target > currentStep) {
      ...
      if (typeof validate === 'function' && validate() === false) return;
    }
    currentStep = target;
    ...
    if (currentStep === 4) { syncDiariasMirrors(); showDiariasSuggestion(); }
  ...
  subscribe((state) => {
    ...
    if (stsEquipe) stsEquipe.textContent = equipe.total > 0
      ? equipe.total + ' servidor' + (equipe.total !== 1 ? 'es' : '')
      : '—';
    if (stsValor) {
  ...
  // ══════════════════════════════════════════════════════════
  //  DIÁRIAS — on-demand suggestion (user-controlled)
  // ══════════════════════════════════════════════════════════
  function showDiariasSuggestion() {
    const dias   = planoState.datas.dias;
    const suggEl = document.getElementById('pt-diarias-suggestion');
    const txtEl  = document.getElementById('pt-diarias-suggestion-text');
    if (!suggEl || !txtEl) return;
    if (dias > 0 && (!diariasQtd || !diariasQtd.value)) {
      txtEl.textContent = 'Sugestão: ' + dias + ' diária' + (dias !== 1 ? 's' : '') + ' (baseado no período)';
      suggEl.classList.add('is-visible');
    } else {
      suggEl.classList.remove('is-visible');
    }
  }

  function applySuggestedDiarias() {
    const dias = planoState.datas.dias;
    if (!dias || !diariasQtd) return;
    diariasQtd.value = String(dias);
    const suggEl = document.getElementById('pt-diarias-suggestion');
    if (suggEl) suggEl.classList.remove('is-visible');
    computeDiarias();
  }
  ...
  [diariasQtd, diariasUnit, diariasTotal].forEach((el) => {
    if (!el) return;
    el.addEventListener('input',  () => { computeDiarias(); if (el === diariasQtd) showDiariasSuggestion(); });
    el.addEventListener('change', () => { computeDiarias(); if (el === diariasQtd) showDiariasSuggestion(); });
  });
  const btnAplicarSugestao = document.getElementById('btn-aplicar-sugestao');
  if (btnAplicarSugestao) btnAplicarSugestao.addEventListener('click', applySuggestedDiarias);
