...
urlpatterns = [
    ...
    path('oficio/<int:pk>/assinatura/', login_required(views_assinatura.oficio_assinatura_gestao), name='oficio-assinatura-gestao'),
    ...
    path('assinatura/oficio/<str:token>/documento-assinado/', views_assinatura.assinatura_oficio_documento_assinado, name='assinatura-oficio-documento-assinado'),
    ...
    path('assinatura/oficio/verificacao/codigo/<str:codigo>/', views_assinatura.assinatura_oficio_verificacao_por_codigo, name='assinatura-oficio-verificacao-codigo'),
    path('assinatura/oficio/<str:token>/pdf/', views_assinatura.assinatura_oficio_pdf_assinado, name='assinatura-oficio-pdf'),
    path('assinatura/oficio/<str:token>/pdf-original/', views_assinatura.assinatura_oficio_pdf_original, name='assinatura-oficio-pdf-original'),
    path('assinatura/oficio/<str:token>/pdf-assinado/', views_assinatura.assinatura_oficio_pdf_final, name='assinatura-oficio-pdf-final'),
