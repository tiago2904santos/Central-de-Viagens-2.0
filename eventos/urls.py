...
urlpatterns = [
    ...
    path('documentos/planos-trabalho/ultimo-rascunho/', login_required(views_global.plano_trabalho_ultimo_rascunho), name='documentos-planos-trabalho-ultimo-rascunho'),
